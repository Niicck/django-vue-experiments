...
To build "docker/build/requirements/production.txt":
    python build_requirements.py

To build "docker/build/requirements/dev.txt":
...
class BuildRequirementsHandler:
    ...
    def export(self):
        ...
        # Don't verify hashes to allow pre-release github version of django-vite to be
        # installed
        export_cmd = export_cmd + " --without-hashes"
